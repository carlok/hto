...
// my extensions
const OnPreHandler = require('./extensions/onprehandler.js');
const OnPostHandler = require('./extensions/onposthandler.js');
...
server.register([
    ...
    { register: OnPostHandler, options: {}, routes: { prefix: process.env.PREFIX } },
...
server.app.encrypt_output = process.env.ENCRYPT_OUTPUT;
